...
/**
 * Node subscription manager subscribers delete form class file.
 */
class NodeSubscribeManageSubscribersDeleteForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'node_subscribe_manage_subscribers_delete_form';
  }
  ...
  private function buildTableAllSubscribers() {
    ...
    $subscribers = Subscriptions::toBeDeleteSubscribers($header);
    $build['table'] = [
      '#type' => 'tableselect',
      '#header' => $header,
      ...
      '#empty' => $this->t('No delete requests found'),
    ];
    $build['pager'] = [
      '#type' => 'pager',
    ];
